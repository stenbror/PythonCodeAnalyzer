...
namespace TestPythonCodeAnalyzer
{
    public class TestParser
    {
        ...
        [Fact]
        public void TestTopLevelStartFuncTypeInputStmtWithArguments7()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("(a, b, *c) -> a + b\r\n\r\n\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestTopLevelStartFuncTypeInputStmtWithArguments8()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("(a, b) -> a + b\r\n\r\n\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestTopLevelStartFuncTypeInputStmtWithArguments9()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("(a,) -> a + b\r\n\r\n\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestTopLevelStartFuncTypeInputStmtWithArguments10()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("(a) -> a + b\r\n\r\n\0".ToCharArray(), false, 8);
        ...
        public void TestVarArgsList1()
        {
            ...
            var node2 = (VarArgumentKWExpression)node.Elements[0];
            Assert.Equal(Token.TokenKind.PyPower, node2.Operator.Kind);
            var node3 = (VFPDefExpression) node2.Right;
            Assert.Equal("a", node3.Name.Text);
        }
        
        [Fact]
        public void TestVarArgsList2()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a,:\r\n\r\n\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestVarArgsList5()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, b, c, **d :\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
            ...
            var node4 = (StarExpression)node.Elements[0];
            Assert.Equal(Token.TokenKind.PyMul, node4.Operator.Kind);
            var node5 = (VFPDefExpression) node4.Right;
            Assert.Equal("a", node5.Name.Text);
            
            var node6 = (VFPDefExpression)node.Elements[1];
            Assert.Equal("b", node6.Name.Text);
            
            var node8 = (VFPDefExpression)node.Elements[2];
            Assert.Equal("c", node8.Name.Text);

            var node2 = (VarArgumentKWExpression)node.Elements[3];
            Assert.Equal(Token.TokenKind.PyPower, node2.Operator.Kind);
            var node3 = (VFPDefExpression) node2.Right;
            Assert.Equal("d", node3.Name.Text);
        }
        
        [Fact]
        public void TestVarArgsList6()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, b = 4, c, **d, :\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
            ...
            var node6 = (VarArgumentExpression)node.Elements[1];
            Assert.Equal("b", ((VFPDefExpression)node6.Left).Name.Text);
        ...
        [Fact]
        public void TestVarArgsList7()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, **d:\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
            ...
            var node2 = (VarArgumentKWExpression)node.Elements[1];
            Assert.Equal(Token.TokenKind.PyPower, node2.Operator.Kind);
            var node3 = (VFPDefExpression) node2.Right;
            Assert.Equal("d", node3.Name.Text);
        }
        ...
        [Fact]
        public void TestVarArgsList8()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, b = 4, c:\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
        ...
        [Fact]
        public void TestVarArgsList9()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 4, c, / , d = 6, f, *g, h, i = j, **t:\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
            
            var node = (VarArgsListExpression) parser.ParseVarArgsList();
            Assert.Equal(0UL, node.Start);
            Assert.Equal(44UL, node.End);

            Assert.True(node.Elements.Length == 9);
            Assert.True(node.Separators.Length == 9);
            ...
            var node9 = (VFPDefExpression)node.Elements[6];
            Assert.Equal("h", node9.Name.Text);
            
            var node10 = (VarArgumentExpression)node.Elements[7];
            Assert.Equal("i", ((VFPDefExpression)node10.Left).Name.Text);
            Assert.Equal("j", ((NameLiteralExpression)node10.Right).Name.Text);
            
            var node11 = (VarArgumentKWExpression)node.Elements[8];
            Assert.Equal(Token.TokenKind.PyPower, node11.Operator.Kind);
            var node12 = (VFPDefExpression) node11.Right;
            Assert.Equal("t", node12.Name.Text);
        }
        
        [Fact]
        public void TestVarArgsList10()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 4, c, / , d = 6, f, *g, h, i = j, **t,:\r\n\r\n\0".ToCharArray(), false, 8);
            ...
            var node = (VarArgsListExpression) parser.ParseVarArgsList();
            Assert.Equal(0UL, node.Start);
            Assert.Equal(45UL, node.End);

            Assert.True(node.Elements.Length == 9);
            Assert.True(node.Separators.Length == 10);
            Assert.Equal(Token.TokenKind.PyDiv, node.Div.Kind);
        ...
        [Fact]
        public void TestVarArgsList11()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 4, c, / , d = 6, f, *g, h, i = j,:\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
        ...
        [Fact]
        public void TestVarArgsList13()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 4, c, / , d = 6,:\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
        ...
        [Fact]
        public void TestVarArgsList17()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 4:\r\n\r\n\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
        ...
        [Fact]
        public void TestTypedArgsList5()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, # type: int\r\n)\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestTypedArgsList6()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, b : c, # type: int\r\n)\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
        ...
        [Fact]
        public void TestTypedArgsList8()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, b : c, d = 4, **e, # type: int\r\n)\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
        ...
        [Fact]
        public void TestTypedArgsList9()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("*a, b : c, d = 4, **e # type: int\r\n)\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestTypedArgsList11()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, # type: int\r\n)\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestTypedArgsList13()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 5, c: d # type: int\r\n)\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
        ...
        [Fact]
        public void TestTypedArgsList14()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
        ...
        [Fact]
        public void TestTypedArgsList15()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 5, c: d, e : f = 8, / , # type: int\r\n)\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestTypedArgsList16()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 5, c: d, e : f = 8, / , **h # type: int\r\n)\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
            
            var node = (TypedArgsStatement) parser.ParseTypedArgsList();
            Assert.Equal(0UL, node.Start);
            Assert.Equal(46UL, node.End);

            Assert.True(node.Elements.Length == 5);
            Assert.True(node.Separators.Length == 5);
            Assert.Equal(Token.TokenKind.PyDiv, node.Div.Kind);
            ...
            var node8 = (TypedPowerArgumentStatement)node.Elements[4];
            Assert.Equal(Token.TokenKind.PyPower, node8.Operator.Kind);
            var node9 = (TFPDefStatement) node8.Right;
        ...
        [Fact]
        public void TestTypedArgsList18()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 5, c: d, e : f = 8, / , i : j = 4, *t, **h # type: int\r\n)\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
            
            var node = (TypedArgsStatement) parser.ParseTypedArgsList();
            Assert.Equal(0UL, node.Start);
            Assert.Equal(61UL, node.End);

            Assert.True(node.Elements.Length == 7);
            Assert.True(node.Separators.Length == 7);
            Assert.Equal(Token.TokenKind.PyDiv, node.Div.Kind);
            ...
            var node8 = (TypedPowerArgumentStatement)node.Elements[6];
            Assert.Equal(Token.TokenKind.PyPower, node8.Operator.Kind);
            var node9 = (TFPDefStatement) node8.Right;
            Assert.Equal("h", node9.Operator1.Text);
            Assert.True(node9.Operator2 == null);
        ...
        [Fact]
        public void TestTypedArgsList19()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 5, c: d, e : f = 8, / , i : j = 4, *t, w : x = y, **h # type: int\r\n)\0".ToCharArray(), false, 8);
            parser.Tokenizer.Advance();
            
            var node = (TypedArgsStatement) parser.ParseTypedArgsList();
            Assert.Equal(0UL, node.Start);
            Assert.Equal(72UL, node.End);
            ...
            var node8 = (TypedPowerArgumentStatement)node.Elements[7];
            Assert.Equal(Token.TokenKind.PyPower, node8.Operator.Kind);
            var node9 = (TFPDefStatement) node8.Right;
            Assert.Equal("h", node9.Operator1.Text);
            Assert.True(node9.Operator2 == null);
        ...
        [Fact]
        public void TestTypedArgsList20()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("a, b = 5, c: d, e : f = 8, / , i : j = 4, *t, w : x = y, h # type: int\r\n)\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestDefSuite1()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("def a(): # type: int\r\n  pass\r\n\0".ToCharArray(), false, 8);
            ...
            Assert.Equal(Token.TokenKind.TypeComment, node2.TypeComment.Kind);
        ...
        public void TestDefSuite2()
        {
            ...
            var node4 = (FuncSuiteStatement)node2.Next;
            Assert.Equal(Token.TokenKind.Newline, node4.Operator1.Kind);
            Assert.Equal(Token.TokenKind.TypeComment, node4.Operator2.Kind);
            Assert.Equal(Token.TokenKind.Newline, node4.Operator3.Kind);
            Assert.Equal(Token.TokenKind.Indent, node4.Operator4.Kind);
            Assert.Equal(Token.TokenKind.Dedent, node4.Operator5.Kind);
        ...
        public void TestForStatementWithTypeCommentAndSuite()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("for a in b: # type: int\r\n   pass\r\n\0".ToCharArray(), false, 8);
        ...
        public void TestWithStatementWithTypeCommentAndSuite()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("with a: # type: int\r\n   pass\r\n\0".ToCharArray(), false, 8);
            ...
            Assert.True(node.Statements.Length == 1);
            var node2 = (WithStatement) node.Statements[0];
            Assert.Equal(Token.TokenKind.PyWith, node2.Operator1.Kind);
            Assert.Equal(Token.TokenKind.PyColon, node2.Operator2.Kind);
            Assert.Equal(Token.TokenKind.TypeComment, node2.TypeComment.Kind);
            
            var node3 = (SuiteStatement) node2.Suite;
            Assert.Equal(Token.TokenKind.Newline, node3.Operator1.Kind);
            Assert.Equal(Token.TokenKind.Indent, node3.Operator2.Kind);
            Assert.True(node3.Statements.Length == 1);
        ...
        [Fact]
        public void TestWithStatementWithoutTypeCommentAndSuite()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("with a:\r\n   pass\r\n\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestCompoundStatementFailingifElifElse1()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("if a pass\0".ToCharArray(), false, 8);
            ...
            catch (SyntaxErrorException e)
            {
                Assert.Equal(5U, e.Position);
                Assert.Equal(Token.TokenKind.PyPass, e.ErrorSymbol.Kind);
                Assert.Equal("Expecting ':' in if statement!", e.Message);
            }
            catch 
            {
                Assert.True(false);
        ...
        [Fact]
        public void TestCompoundStatementFailingifElifElse2()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("if a: pass\r\nelif b pass\0".ToCharArray(), false, 8);
            ...
            {
                Assert.Equal(19U, e.Position);
                Assert.Equal(Token.TokenKind.PyPass, e.ErrorSymbol.Kind);
                Assert.Equal("Expecting ':' in elif statement!", e.Message);
            }
            catch 
            {
                Assert.True(false);
        ...
        [Fact]
        public void TestCompoundStatementFailingifElifElse3()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("if a: pass\r\nelif b: pass\r\nelse pass\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestCompoundStatementFailingWhile()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("while a pass\0".ToCharArray(), false, 8);
            ...
            catch (SyntaxErrorException e)
            {
                Assert.Equal(8U, e.Position);
                Assert.Equal(Token.TokenKind.PyPass, e.ErrorSymbol.Kind);
                Assert.Equal("Expecting ':' in while statement!", e.Message);
            }
            catch 
            {
                Assert.True(false);
        ...
        [Fact]
        public void TestCompoundStatementFailingWhileElse()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("while a: pass\r\nelse pass\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestCompoundStatementFailingForMissingIn()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("for a b: pass\0".ToCharArray(), false, 8);
            ...
            catch (SyntaxErrorException e)
            {
                Assert.Equal(6U, e.Position);
                Assert.Equal(Token.TokenKind.Name, e.ErrorSymbol.Kind);
                Assert.Equal("Expecting 'in' in for statement!", e.Message);
            }
            catch 
            {
                Assert.True(false);
        ...
        [Fact]
        public void TestCompoundStatementFailingForMissingColon()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("for a in b pass\0".ToCharArray(), false, 8);
            ...
            catch (SyntaxErrorException e)
            {
                ...
                Assert.Equal(Token.TokenKind.PyPass, e.ErrorSymbol.Kind);
                Assert.Equal("Expecting ':' in for statement!", e.Message);
            }
            catch 
            {
                Assert.True(false);
        ...
        [Fact]
        public void TestCompoundStatementFailingTryStmt3()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("try:\r\n  pass\r\nfinally pass\0".ToCharArray(), false, 8);
            ...
            catch (SyntaxErrorException e)
            {
                ...
                Assert.Equal(Token.TokenKind.PyPass, e.ErrorSymbol.Kind);
                Assert.Equal("Expecting ':' in finally part of try statement!", e.Message);
            }
            catch 
            {
                Assert.True(false);
        ...
        [Fact]
        public void TestCompoundStatementFailingTryStmt5()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("try:\r\n  pass\r\nexcept a:  pass\r\nelse pass\0".ToCharArray(), false, 8);
        ...
        [Fact]
        public void TestCompoundStatementFailingTryStmt6()
        {
            var parser = new PythonParser();
            Assert.True(parser != null);
            parser.Tokenizer = new PythonTokenizer("try:\r\n  pass\r\nexcept a:  pass\r\nelse:\r\npass\0".ToCharArray(), false, 8);
            ...
            {
                Assert.Equal(38U, e.Position);
                Assert.Equal(Token.TokenKind.PyPass, e.ErrorSymbol.Kind);
                Assert.Equal("Expecting indent in block level of statement block!", e.Message);
            }
            catch 
            {
                Assert.True(false);
